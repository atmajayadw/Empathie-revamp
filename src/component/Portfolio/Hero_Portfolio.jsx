...
function Hero_Portfolio() {
    const setLoaderOn = () => {
        const hero = document.getElementById("hero-portfolio");
        const category = document.getElementById("category-portfolio");
        ...
        setTimeout(() => {
            ...
            category.classList.add("animate__animated", "animate__fadeIn", "animate__delay-1s");
